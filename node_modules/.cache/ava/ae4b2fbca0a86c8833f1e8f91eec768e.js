...
(0, _ava2.default)('converts orange', function (t) {
	...
	t.deepEqual(_rec5._expr(_rec5._capt((0, _index2.default)('#FF8A00'), 'arguments/0'), {
		content: 't.deepEqual(hexToHsl(\'#FF8A00\'), [32, 100, 50])',
		filepath: 'test/colors.js',
		line: 13
	}), _rec6._expr(_rec6._capt([32, 100, 50], 'arguments/1'), {
		content: 't.deepEqual(hexToHsl(\'#FF8A00\'), [32, 100, 50])',
		filepath: 'test/colors.js',
		line: 13
	}));
...
(0, _ava2.default)('converts purple', function (t) {
	...
	t.deepEqual(_rec7._expr(_rec7._capt((0, _index2.default)('#A900C7'), 'arguments/0'), {
		content: 't.deepEqual(hexToHsl(\'#A900C7\'), [291, 100, 39])',
		filepath: 'test/colors.js',
		line: 17
	}), _rec8._expr(_rec8._capt([291, 100, 39], 'arguments/1'), {
		content: 't.deepEqual(hexToHsl(\'#A900C7\'), [291, 100, 39])',
		filepath: 'test/colors.js',
		line: 17
	}));
...
//# sourceMappingURL=../node_modules/.cache/ava/ae4b2fbca0a86c8833f1e8f91eec768e.js.map